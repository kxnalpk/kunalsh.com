<script>
    ...
    let projects = [
        ...
        },
        {
          ...
          text: "An end-to-end encrypted CLI chat application for Windows 10 and 11. I created this to learn C++ and understand socket programming. You can talk directly through your console."
        }
    ];
